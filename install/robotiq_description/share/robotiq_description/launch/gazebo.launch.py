...
def generate_launch_description():
    ...
    # 1. CORRECT GAZEBO LAUNCH (Points directly to your custom world)
    ...
    # Set model path so Gazebo Harmonic knows where to find your custom meshes/models
    set_gz_model_path = SetEnvironmentVariable(
        name='GZ_SIM_RESOURCE_PATH',
        value=f"{fruit_models_dir}:{robotiq_models_dir}"
    )
